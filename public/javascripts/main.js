...
const scrollUp = () => {
    ...
    // When the scroll is higher than 3510 viewport height, add the show-scroll class to the a tag with the scrollup class
...
// Activate / deactivate the theme manually with the button themeButton.addEventListener('click', () => {
themeButton.addEventListener('click', () => {
    ...
    // We save the theme and the current icon that the user chose localStorage.setItem('selected-theme', getCurrent Theme())
